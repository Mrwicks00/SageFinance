 ...
 */
declare function createTEEProject(projectName: string, targetDir: string, database: string, aiModel: string, isNonInteractive?: boolean): Promise<void>;
/**
 * Creates a new regular project with the specified name and configuration.
 */
declare function createProject(projectName: string, targetDir: string, database: string, aiModel: string, isNonInteractive?: boolean): Promise<void>;
 ...
 */
declare function setupProjectEnvironment(targetDir: string, database: string, aiModel: string, isNonInteractive?: boolean): Promise<void>;

export { createAgent, createPlugin, createProject, createProjectDirectories, createTEEProject, installDependencies, setupAIModelConfig, setupProjectEnvironment };
